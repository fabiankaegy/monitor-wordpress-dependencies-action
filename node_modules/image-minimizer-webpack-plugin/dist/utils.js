...
async function imageminGenerate(original, minimizerOptions) {
  var _original$info$genera, _original$info;
  ...
  return {
    ...
    info: { ...original.info,
      generated: true,
      generatedBy: ["imagemin", ...((_original$info$genera = (_original$info = original.info) === null || _original$info === void 0 ? void 0 : _original$info.generatedBy) !== null && _original$info$genera !== void 0 ? _original$info$genera : [])]
    }
  };
}
/**
...
async function imageminMinify(original, options) {
  var _original$info$minimi, _original$info2;
  ...
  return {
    ...
    info: { ...original.info,
      minimized: true,
      minimizedBy: ["imagemin", ...((_original$info$minimi = (_original$info2 = original.info) === null || _original$info2 === void 0 ? void 0 : _original$info2.minimizedBy) !== null && _original$info$minimi !== void 0 ? _original$info$minimi : [])]
    }
  };
}
/**
...
function squooshImagePoolSetup() {
  if (!pool) {
    var _os$cpus$length, _os$cpus;

    const os = require("os"); // In some cases cpus() returns undefined
    // https://github.com/nodejs/node/issues/19022


    const threads = (_os$cpus$length = (_os$cpus = os.cpus()) === null || _os$cpus === void 0 ? void 0 : _os$cpus.length) !== null && _os$cpus$length !== void 0 ? _os$cpus$length : 1;
    pool = squooshImagePoolCreate(threads); // workarounds for https://github.com/GoogleChromeLabs/squoosh/issues/1152
    // @ts-ignore
...
async function squooshGenerate(original, minifyOptions) {
  var _original$info$genera2, _original$info3;
  ...
  const preprocEntries = Object.entries(squooshOptions).filter(([key, value]) => {
    if (key === "resize" && (value === null || value === void 0 ? void 0 : value.enabled) === false) {
      return false;
    }
  ...
  return {
    ...
    info: { ...original.info,
      ...
      height,
      generated: true,
      generatedBy: ["squoosh", ...((_original$info$genera2 = (_original$info3 = original.info) === null || _original$info3 === void 0 ? void 0 : _original$info3.generatedBy) !== null && _original$info$genera2 !== void 0 ? _original$info$genera2 : [])]
    }
  };
}
...
async function squooshMinify(original, options) {
  var _original$info$minimi2, _original$info4;
  ...
  return {
    ...
    info: { ...original.info,
      ...
      height,
      minimized: true,
      minimizedBy: ["squoosh", ...((_original$info$minimi2 = (_original$info4 = original.info) === null || _original$info4 === void 0 ? void 0 : _original$info4.minimizedBy) !== null && _original$info$minimi2 !== void 0 ? _original$info$minimi2 : [])]
    }
  };
}
...
const SHARP_FORMATS = new Map([["avif", "avif"], ["gif", "gif"], ["heic", "heif"], ["heif", "heif"], ["j2c", "jp2"], ["j2k", "jp2"], ["jp2", "jp2"], ["jpeg", "jpeg"], ["jpg", "jpeg"], ["jpx", "jp2"], ["png", "png"], ["raw", "raw"], ["tif", "tiff"], ["tiff", "tiff"], ["webp", "webp"]]);
/**
 * @param {WorkerResult} original
...
async function sharpTransform(original, minimizerOptions = {}, targetFormat = null) {
  var _minimizerOptions$enc, _original$info$proces, _original$info5;
  ...
  const outputFormat = targetFormat !== null && targetFormat !== void 0 ? targetFormat :
  /** @type {SharpFormat} */
  imageMetadata.format;
  const encodeOptions = (_minimizerOptions$enc = minimizerOptions.encodeOptions) === null || _minimizerOptions$enc === void 0 ? void 0 : _minimizerOptions$enc[outputFormat];
  ...
  return {
    ...
    info: { ...original.info,
      ...
      height,
      [processedFlag]: true,
      [processedBy]: ["sharp", ...((_original$info$proces = (_original$info5 = original.info) === null || _original$info5 === void 0 ? void 0 : _original$info5[processedBy]) !== null && _original$info$proces !== void 0 ? _original$info$proces : [])]
    }
  };
}
/**
...
function sharpGenerate(original, minimizerOptions) {
  var _sharpOptions$encodeO;

  const sharpOptions =
  /** @type {SharpOptions} */
  minimizerOptions !== null && minimizerOptions !== void 0 ? minimizerOptions : {};
  const targetFormats =
  /** @type {SharpFormat[]} */
  Object.keys((_sharpOptions$encodeO = sharpOptions.encodeOptions) !== null && _sharpOptions$encodeO !== void 0 ? _sharpOptions$encodeO : {});
...
function sharpMinify(original, minimizerOptions) {
  return sharpTransform(original,
  /** @type {SharpOptions} */
  minimizerOptions);
}
